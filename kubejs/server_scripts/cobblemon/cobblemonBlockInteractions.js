...
0.2 * rnd(1, 4),
  25,
  0.01);{block.set("minecraft:stone")
...
0.2 * rnd(1, 4),
  25,
  0.01);{block.set("minecraft:glass")
      if (Math.random() < 0.1) item.count--; };
         (server.runCommandSilent(
          `playsound minecraft:block.fire.extinguish block @a ${player.x} ${player.y} ${player.z}` ))
}}}),
...
0.2 * rnd(1, 4),
  25,
  0.01);{block.set("minecraft:terracotta")
      if (Math.random() < 0.1) item.count--; };
         (server.runCommandSilent(
          `playsound minecraft:block.fire.extinguish block @a ${player.x} ${player.y} ${player.z}` ))
}}}),
...
0.2 * rnd(1, 4),
  25,
  0.01);{block.set("minecraft:grass_block")
      if (Math.random() < 0.1) item.count--; };
         (server.runCommandSilent(
...
0.2 * rnd(1, 4),
  25,
  0.01);{block.set("vinery:grass_slab")
      if (Math.random() < 0.1) item.count--; };
         (server.runCommandSilent(
          `playsound minecraft:item.bone_meal.use block @a ${player.x} ${player.y} ${player.z}` ))
}}}),
...
0.2 * rnd(1, 4),
  25,
  0.01);{block.set("quark:charcoal_block")
      if (Math.random() < 0.1) item.count--; };
         (server.runCommandSilent(
          `playsound minecraft:block.fire.extinguish block @a ${player.x} ${player.y} ${player.z}` ))
}}}),
...
0.2 * rnd(1, 4),
  25,
  0.01);{block.set("dew_drop_farmland_growth:deluxe_hydrating_farmland")
      item.count--; };
         (server.runCommandSilent(
          `playsound minecraft:item.bone_meal.use block @a ${player.x} ${player.y} ${player.z}` ))
}}}),
...
0.2 * rnd(1, 4),
  10,
  0.01);{block.set("minecraft:budding_amethyst")
      item.count--; };
         (server.runCommandSilent(
