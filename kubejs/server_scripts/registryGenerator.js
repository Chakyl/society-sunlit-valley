...
const dishes = [
    ...
    { dish: "farmersdelight:steak_and_potatoes", ingredients: ["minecraft:baked_potato", "minecraft:cooked_beef", "minecraft:bowl", "farmersdelight:onion", "farmersdelight:cooked_rice"], cookedCount: 1, type: "crafting_shapeless" },
    ...
    { dish: "veggiesdelight:potato_noodles", ingredients: ["veggiesdelight:potato_noodle", "veggiesdelight:garlic", "farmersdelight:onion"], cookedCount: 1, type: "cooking_pot" },
    // // Sweet Potatoes
    { dish: "veggiesdelight:baked_sweet_potato", ingredients: ["veggiesdelight:sweet_potato"], cookedCount: 1, type: "smoker" },
    { dish: "veggiesdelight:sweet_potato_pie", ingredients: ["veggiesdelight:baked_sweet_potato", "veggiesdelight:baked_sweet_potato", "veggiesdelight:baked_sweet_potato", "minecraft:sugar", "farmersdelight:pie_crust", "minecraft:sugar"], cookedCount: 1, type: "oven" },
    { dish: "veggiesdelight:sweet_potato_pie_slice", ingredients: ["veggiesdelight:sweet_potato_pie"], cookedCount: 4, type: "feast" },
    { dish: "veggiesdelight:mashed_potatoes", ingredients: ["veggiesdelight:sweet_potato", "#c:crops/potato", "#society:small_milk"], cookedCount: 1, type: "cooking_pot" },
    { dish: "veggiesdelight:sweet_potato_pancakes", ingredients: ["veggiesdelight:sweet_potato_dough", "minecraft:honey_bottle", "#society:small_milk"], cookedCount: 1, type: "cooking_pot" },
    { dish: "veggiesdelight:sweet_potato_cupcake", ingredients: ["veggiesdelight:sweet_potato_dough", "#c:eggs", "#society:small_milk"], cookedCount: 1, type: "oven" },
    // // Cucumber
    { dish: "vintagedelight:cucumber_salad", ingredients: ["#c:foods/vegetable", "vintagedelight:pickled_beetroot", "vintagedelight:pickled_onion", "vintagedelight:cucumber", "minecraft:bowl"], cookedCount: 1, type: "crafting_shapeless" },
    { dish: "vintagedelight:cucumber_noodles", ingredients: ["vintagedelight:cucumber_dough"], cookedCount: 1, type: "chopping" },
    { dish: "unusualfishmod:pickledish", ingredients: ["vintagedelight:cucumber", "unusualfishmod:raw_picklefish", "minecraft:sea_pickle", "minecraft:bowl"], cookedCount: 1, type: "crafting_shapeless" },
    { dish: "vintagedelight:pickle_soup", ingredients: ["vintagedelight:pickle", "farmersdelight:onion", "minecraft:potato", "minecraft:bowl"], cookedCount: 1, type: "cooking_pot" },
    // // Eggplant
    { dish: "culturaldelights:smoked_eggplant", ingredients: ["culturaldelights:eggplant"], cookedCount: 1, type: "smoker" },
    { dish: "culturaldelights:poached_eggplants", ingredients: ["#c:crops/eggplant", "farmersdelight:onion", "farmersdelight:tomato_sauce", "#c:eggs"], cookedCount: 1, type: "cooking_pot" },
    { dish: "culturaldelights:eggplant_burger", ingredients: ["minecraft:bread", "culturaldelights:eggplant", "#c:foods/leafy_green", "farmersdelight:tomato"], cookedCount: 1, type: "crafting_shapeless" },
    { dish: "culturaldelights:eggplant_parmesan_block", ingredients: ["culturaldelights:eggplant", "#society:small_milk", "#c:eggs", "farmersdelight:raw_pasta", "farmersdelight:tomato_sauce", "#c:foods/bread"], cookedCount: 1, type: "cooking_pot" },
    { dish: "culturaldelights:eggplant_parmesan", ingredients: ["culturaldelights:eggplant_parmesan_block"], cookedCount: 4, type: "feast" },
    // // Corn
    { dish: "culturaldelights:popcorn", ingredients: ["culturaldelights:corn_kernels"], cookedCount: 1, type: "smoker" },
    { dish: "culturaldelights:creamed_corn", ingredients: ["#society:small_milk", "culturaldelights:corn", "culturaldelights:corn"], cookedCount: 1, type: "cooking_pot" },
    { dish: "culturaldelights:elote", ingredients: ["#society:mayo", "culturaldelights:corn", "farmersdelight:onion", "#c:cheese"], cookedCount: 1, type: "cooking_pot" },
    // // Ghost Pepper
    { dish: "vintagedelight:ghost_charcoal", ingredients: ["vintagedelight:ghost_pepper"], cookedCount: 1, type: "smoker" },
    { dish: "vintagedelight:ghostly_chili", ingredients: ["vintagedelight:ghost_pepper", "vintagedelight:ghost_pepper", "minecraft:carrot", "farmersdelight:tomato", "farmersdelight:minced_beef"], cookedCount: 1, type: "cooking_pot" },
    { dish: "culturaldelights:spicy_curry", ingredients: ["minecraft:blaze_powder", "farmersdelight:tomato_sauce", "farmersdelight:cooked_rice", "farmersdelight:onion", "#culturaldelights:cooked_chickens", "#society:small_milk"], cookedCount: 1, type: "cooking_pot" },
    // // Peanut
    { dish: "vintagedelight:pad_thai", ingredients: ["farmersdelight:raw_pasta", "farmersdelight:raw_pasta", "vintagedelight:peanut", "#c:eggs", "minecraft:dried_kelp"], cookedCount: 1, type: "cooking_pot" },
    { dish: "vintagedelight:honey_roasted_peanut", ingredients: ["vintagedelight:roasted_peanut", "vintagedelight:roasted_peanut", "vintagedelight:roasted_peanut", "vintagedelight:roasted_peanut", "vintagedelight:roasted_peanut", "minecraft:honey_bottle"], cookedCount: 5, type: "cooking_pot" },
    { dish: "vintagedelight:roasted_peanut", ingredients: ["vintagedelight:peanut"], cookedCount: 1, type: "smoker" },
    { dish: "vintagedelight:pb_j", ingredients: ["minecraft:bread", "vintagedelight:nut_mash_bottle", "#cintagedelight:sweet_jam_bottles"], cookedCount: 1, type: "crafting_shapeless" },
    // // Onion
    { dish: "farmersdelight:onion_soup", ingredients: ["farmersdelight:onion", "farmersdelight:onion", "minecraft:bread", "#society:small_milk"], cookedCount: 1, type: "cooking_pot"},
