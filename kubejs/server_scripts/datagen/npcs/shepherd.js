  ...
  runNpcDatagen("shepherd", {
    ...
    chatter: {
      ...
      friendship1: [
        ...
        ["No need to stop around so often", "I'm more than capable of handling"],
        [
        ...
        ["Everything is so calm and simple around here...", "For now!"],
        ...
        ["Everybody lies, but animals will always tell you the truth.", "Except racoons!! They never just take one fry!"],
        ...
        ["I miss the stray cats of the city I grew up in...", "Stray cows are a different kind of nice."],
      ],
      friendship2: [
        ...
        ["Some people can be so dissapointing in life.", "Ahh but nobody here is like that! Probably..."],
        [
