...
if (global.datagenDialog) {
  runNpcDatagen("blacksmith", {
    name: "Aiden",
    intro: [
      "Heya @p! Ace told me all about your plans here in the valley.",
    ...
    chatter: {
      friendship0: [
        ...
        "Hello there @p, do you need something?",
        ...
        "How's your farm going @p?",
        ["Ace told me so much about the valley before I moved here.", "The love they have for nature really shows!"],
        ["Hmm... raw materials are plentiful underground, but the caves are crawling with monsters.", "Be safe down there @p!"],
        ...
        "Hey @p, how's the farm going today?",
      ...
      friendship1: [
        ...
        "Ahh I can't chat today @p, too much to do!",
        "What can I do for you today @p?",
        "Heya @p! What do you need!",
      ...
      friendship2: [
        "Busy day today @p?",
        ["How's it going @p?", "It's a beautiful day today."],
        "Heya @p! I was hoping you'd come around today!",
        "Whatcha up to @p? Wanting to upgrade to gold tools yet?",
        "Too busy to chat @p, Maria just put in a huge order!",
      ...
      friendship3: [
        ...
        "Hey @p! I was hoping I'd see you soon!",
        "What can I help you with @p?",
      ...
      friendship4: [
        "Well well well, @p's back in my shop!",
        "Hey friend, what can I get you!",
        "Lovely day today @p, what do you need?",
