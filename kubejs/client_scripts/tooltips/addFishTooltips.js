ItemEvents.tooltip((tooltip) => {
  ...
  tooltip.add(yearRound, [Text.of(" "), Text.translate("desc.sereneseasons.year_round").lightPurple()]);
  ...
  global.springOcean.forEach((entry) =>
    addSeasonTooltip(entry.fish, Text.translate("desc.sereneseasons.spring").green(), springFish)
  );
  ...
  global.summerOcean.forEach((entry) =>
    addSeasonTooltip(entry.fish, Text.translate("desc.sereneseasons.summer").yellow(), summerFish)
  );
  ...
  global.autumnOcean.forEach((entry) =>
    addSeasonTooltip(entry.fish, Text.translate("desc.sereneseasons.autumn").gold(), autumnFish)
  );
  ...
  global.winterOcean.forEach((entry) =>
    addSeasonTooltip(entry.fish, Text.translate("desc.sereneseasons.winter").aqua(), winterFish)
  );
