...
StartupEvents.registry("block", (e) => {
  e.create("society:ancient_fruit", "crop")
    .age(10, (builder) => {
      builder
  ...
  e.create("society:blueberry", "crop")
    .age(14, (builder) => {
      builder
        ...
        .shape(6, 0, 0, 0, 16, 12, 16)
        .shape(7, 0, 0, 0, 16, 12, 16)
        .shape(8, 0, 0, 0, 16, 12, 16)
        .shape(9, 0, 0, 0, 16, 16, 16)
        .shape(10, 0, 0, 0, 16, 16, 16)
        .shape(11, 0, 0, 0, 16, 16, 16)
        .shape(12, 0, 0, 0, 16, 16, 16)
        .shape(13, 0, 0, 0, 16, 16, 16)
        .shape(14, 0, 0, 0, 16, 20, 16);
    })
    .survive((state, level, pos) => global.surviveCheck(level, pos))
    // .dropSeed(false)
  ...
  // e.create("society:sweet_potato", "crop")
  //   .age(5, (builder) => {
  //     builder
  //       .shape(0, 0, 0, 0, 16, 4, 16)
  //       .shape(1, 0, 0, 0, 16, 6, 16)
  ...
  e.create("society:sparkpod", "crop")
    .age(8, (builder) => {
      builder
        .shape(0, 0, 0, 0, 16, 3, 16)
