StartupEvents.registry("block", (event) => {
    ...
    event.create('society:skull_arid_sandstone')
    event.create('society:skull_blackstone')
    event.create('society:skull_cavern_teleporter')
    event.create('society:skull_end_stone')
    event.create('society:skull_permafrost')
    event.create('society:skull_sandstone')
    event.create('society:skull_stone')
